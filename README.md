...
Examples: 
	...
	./miREC.sh -f ./Data/simulated_data/mix_data/simumD1.fq -s 10 -e 15 -t 26 -u -o Correct.fastq(correct substitution errors only, with threshold_value 5 and k_value from 10 to 12, with 26 threads; Setting output file name as Correct.fastq)
